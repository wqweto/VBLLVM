...
#define LLVM_TARGET(TargetName) \
  void LLVM_STDCALL LLVMInitialize##TargetName##TargetInfo(void);
...
#define LLVM_TARGET(TargetName) \
  void LLVM_STDCALL LLVMInitialize##TargetName##TargetMC(void);
#include "llvm/Config/Targets.def"
#undef LLVM_TARGET  /* Explicit undef to make SWIG happier */

/* Declare all of the available assembly printer initialization functions. */
#define LLVM_ASM_PRINTER(TargetName) \
  void LLVM_STDCALL LLVMInitialize##TargetName##AsmPrinter(void);
#include "llvm/Config/AsmPrinters.def"
#undef LLVM_ASM_PRINTER  /* Explicit undef to make SWIG happier */

/* Declare all of the available assembly parser initialization functions. */
#define LLVM_ASM_PARSER(TargetName) \
  void LLVM_STDCALL LLVMInitialize##TargetName##AsmParser(void);
#include "llvm/Config/AsmParsers.def"
#undef LLVM_ASM_PARSER  /* Explicit undef to make SWIG happier */

/* Declare all of the available disassembler initialization functions. */
#define LLVM_DISASSEMBLER(TargetName) \
  void LLVM_STDCALL LLVMInitialize##TargetName##Disassembler(void);
...
/** LLVMInitializeAllTargetInfos - The main program should call this function if
    ...
    support. */
static inline void LLVM_STDCALL LLVMInitializeAllTargetInfos(void) {
...
/** LLVMInitializeAllTargets - The main program should call this function if it
    ...
    support. */
static inline void LLVM_STDCALL LLVMInitializeAllTargets(void) {
...
/** LLVMInitializeAllTargetMCs - The main program should call this function if
    ...
    support. */
static inline void LLVM_STDCALL LLVMInitializeAllTargetMCs(void) {
...
static inline void LLVM_STDCALL LLVMInitializeAllAsmPrinters(void) {
...
/** LLVMInitializeAllAsmParsers - The main program should call this function if
    ...
    available via the TargetRegistry. */
static inline void LLVM_STDCALL LLVMInitializeAllAsmParsers(void) {
...
static inline void LLVM_STDCALL LLVMInitializeAllDisassemblers(void) {
#define LLVM_DISASSEMBLER(TargetName) \
...
static inline LLVMBool LLVM_STDCALL LLVMInitializeNativeTarget(void) {
...
/** LLVMInitializeNativeTargetAsmParser - The main program should call this
    ...
    host. */
static inline LLVMBool LLVM_STDCALL LLVMInitializeNativeAsmParser(void) {
...
/** LLVMInitializeNativeTargetAsmPrinter - The main program should call this
    ...
    the host. */
static inline LLVMBool LLVM_STDCALL LLVMInitializeNativeAsmPrinter(void) {
...
/** LLVMInitializeNativeTargetDisassembler - The main program should call this
    ...
    to the host. */
static inline LLVMBool LLVM_STDCALL LLVMInitializeNativeDisassembler(void) {
...
enum LLVMByteOrdering LLVM_STDCALL LLVMByteOrder(LLVMTargetDataRef TD);
...
/** Returns the integer type that is the same size as a pointer on a target.
    This version allows the address space to be specified.
    See the method llvm::DataLayout::getIntPtrType. */
LLVMTypeRef LLVM_STDCALL LLVMIntPtrTypeForASInContext(LLVMContextRef C, LLVMTargetDataRef TD,
                                         unsigned AS);
...
/** Computes the byte offset of the indexed struct element for a target.
    See the method llvm::StructLayout::getElementContainingOffset. */
unsigned long long LLVM_STDCALL LLVMOffsetOfElement(LLVMTargetDataRef TD,
